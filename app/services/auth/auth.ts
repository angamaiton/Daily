...
export class AuthService {
  ...
  auth0 = new Auth0({clientID: 'eLbPUp6fDP467ffvWXoCR4rGMuqNP0Zh', domain: 'angamaiton.auth0.com'});
  lock = new Auth0Lock('eLbPUp6fDP467ffvWXoCR4rGMuqNP0Zh', 'angamaiton.auth0.com', {
    auth: {
      redirect: false,
      params: {
